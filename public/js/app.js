...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    showInstructionsClick: function showInstructionsClick() {
      this.showInstructions = true;
    },
    hideInstructionsClick: function hideInstructionsClick() {
    ...
    play: function play() {
      ...
      axios.post('/api/hand', {
        ...
        this.message = "Computer played: " + response.data.data.computer_play + "!  Your score was " + response.data.data.user_score + " vs the computer's score of " + response.data.data.computer_score;
          ...
          _c("div", { staticClass: "card-body" }, [
            ...
            _c("div", { staticClass: "row" }, [
              _c("div", { staticClass: "col my-1" }, [
                _c(
                  "button",
                  { staticClass: "btn btn-primary", on: { click: _vm.play } },
                  [_vm._v("\n                      Play\n                  ")]
                )
              ])
            ])
              ...
              _c("div", { staticClass: "col my-1" }, [
                _c(
                  ...
                  [
                    _vm._m(1),
                    _vm._v(" "),
                    _vm._l(_vm.leaderboard, function(entry) {
      ...
      ? _c("div", { staticClass: "row" }, [
          _c("div", { staticClass: "col alert alert-info" }, [
            ...
            _c(
              ...
              {
                staticClass: "btn btn-primary btn-sm",
                on: { click: _vm.hideInstructionsClick }
              },
              [_vm._v("\n              Hide Instructions\n          ")]
            )
          ])
      ...
      ? _c("div", { staticClass: "row" }, [
          _c("div", { staticClass: "col" }, [
            _c(
              ...
              {
                staticClass: "btn btn-primary btn-sm",
                on: { click: _vm.showInstructionsClick }
              },
              [_vm._v("\n        Instructions\n      ")]
            )
          ])
